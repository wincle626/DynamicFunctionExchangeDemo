...
#CLK_125MHZ_P - ZCU102 - 
set_property PACKAGE_PIN F21      [get_ports "clk_n"] ;# Bank  28 VCCO - VCC1V8   - IO_L13N_T2L_N1_GC_QBC_28
set_property IOSTANDARD  LVDS_25     [get_ports "clk_n"] ;# Bank  28 VCCO - VCC1V8   - IO_L13N_T2L_N1_GC_QBC_28
set_property PACKAGE_PIN G21      [get_ports "clk_p"] ;# Bank  28 VCCO - VCC1V8   - IO_L13P_T2L_N0_GC_QBC_28
set_property IOSTANDARD  LVDS_25     [get_ports "clk_p"] ;# Bank  28 VCCO - VCC1V8   - IO_L13P_T2L_N0_GC_QBC_28

#GPIO_SW_C (SW7)  - KCU105 - AE10/LVCMOS18
set_property PACKAGE_PIN AM13      [get_ports "rst_n"] ;# Bank  87 VCCO - VCC3V3   - IO_L4N_AD8N_87
set_property IOSTANDARD  LVCMOS33 [get_ports "rst_n"] ;# Bank  87 VCCO - VCC3V3   - IO_L4N_AD8N_87

#GPIO_LED_0 
set_property PACKAGE_PIN AG14 [get_ports {shift_high_out}]
...
#GPIO_LED_2 
set_property PACKAGE_PIN AF13 [get_ports {shift_low_out[1]}]
