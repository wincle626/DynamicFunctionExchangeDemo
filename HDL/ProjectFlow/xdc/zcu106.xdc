...
#CLK_125MHZ_P - ZCU106 - 
set_property PACKAGE_PIN G9      [get_ports "clk_n"] ;# Bank  28 VCCO - VCC1V8   - IO_L13N_T2L_N1_GC_QBC_28
set_property IOSTANDARD  LVDS     [get_ports "clk_n"] ;# Bank  28 VCCO - VCC1V8   - IO_L13N_T2L_N1_GC_QBC_28
set_property PACKAGE_PIN H9      [get_ports "clk_p"] ;# Bank  28 VCCO - VCC1V8   - IO_L13P_T2L_N0_GC_QBC_28
...
set_property PACKAGE_PIN G13      [get_ports "rst_n"] ;# Bank  87 VCCO - VCC3V3   - IO_L4N_AD8N_87
set_property IOSTANDARD  LVCMOS18 [get_ports "rst_n"] ;# Bank  87 VCCO - VCC3V3   - IO_L4N_AD8N_87

#GPIO_LED_0 
set_property PACKAGE_PIN AL11 [get_ports {shift_high_out}]
set_property IOSTANDARD LVCMOS12 [get_ports {shift_high_out}]

#GPIO_LED_1 
set_property PACKAGE_PIN AL13 [get_ports {shift_low_out[2]}]
set_property IOSTANDARD LVCMOS12 [get_ports {shift_low_out[2]}]

#GPIO_LED_2 
set_property PACKAGE_PIN AK13 [get_ports {shift_low_out[1]}]
set_property IOSTANDARD LVCMOS12 [get_ports {shift_low_out[1]}]

#GPIO_LED_3 
set_property PACKAGE_PIN AE15 [get_ports {shift_low_out[0]}]
