...
//Date        : Thu Jun 16 17:40:58 2022
//Host        : Alienware17R3 running 64-bit major release  (build 9200)
//Command     : generate_target bram_blk0_inst_0.bd
//Design      : bram_blk0_inst_0
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bram_blk0_inst_0,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bram_blk0_inst_0,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=E_/UDRC_HW/workspaces/vivado2021.2/PR_Test04/PR_Test04.srcs/sources_1/bd/bram_blk0/bram_blk0.bd,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "bram_blk0_inst_0.hwdef" *) 
module bram_blk0_inst_0
   (S_AXI_araddr,
    S_AXI_arburst,
    S_AXI_arcache,
    S_AXI_arid,
  ...
  bram_blk0_inst_0_axi_bram_ctrl_0_0 axi_bram_ctrl_0
  ...
  bram_blk0_inst_0_blk_mem_gen_0_0 blk_mem_gen_0
