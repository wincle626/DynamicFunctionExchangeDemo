...
#
# Generated by export_simulation on Thu Jun 16 17:24:56 +0100 2022
#
################################################################################
...
'-reset_run' switch to the './bram_blk0.sh' script.

./bram_blk0.sh -reset_run
...
./bram_blk0.sh -noclean_files

For more information on the script, please type './bram_blk0.sh -help'.
