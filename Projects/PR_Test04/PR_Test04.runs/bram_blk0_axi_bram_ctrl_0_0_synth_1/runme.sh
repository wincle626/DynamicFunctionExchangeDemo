...
HD_PWD='E:/UDRC_HW/workspaces/vivado2021.2/PR_Test04/PR_Test04.runs/bram_blk0_axi_bram_ctrl_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_blk0_axi_bram_ctrl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_blk0_axi_bram_ctrl_0_0.tcl
