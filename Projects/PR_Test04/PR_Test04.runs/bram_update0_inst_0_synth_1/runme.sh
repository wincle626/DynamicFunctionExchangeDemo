...
HD_PWD='E:/UDRC_HW/workspaces/vivado2021.2/PR_Test04/PR_Test04.runs/bram_update0_inst_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_update0_inst_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_update0_inst_0.tcl
