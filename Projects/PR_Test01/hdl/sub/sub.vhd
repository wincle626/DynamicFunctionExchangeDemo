...
architecture behav of sub is 
    ...
    "sub,hls_ip_2019_1_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu7ev-ffvc1156-2-e,HLS_INPUT_CLOCK=3.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=2.464000,HLS_SYN_LAT=10,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=2,HLS_SYN_FF=580,HLS_SYN_LUT=430,HLS_VERSION=2019_1_3}";
    ...
    component sub_fsub_32ns_32nbkb IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    sub_fsub_32ns_32nbkb_U1 : component sub_fsub_32ns_32nbkb
    generic map (
        ID => 1,
        NUM_STAGE => 10,
        din0_WIDTH => 32,
    ...
    grp_fu_57_ce_assign_proc : process(ap_start, ap_CS_fsm_state1, a_0_vld_out, b_0_vld_out, c_1_ack_in, ap_CS_fsm_state10, ap_CS_fsm_state11)
    begin
