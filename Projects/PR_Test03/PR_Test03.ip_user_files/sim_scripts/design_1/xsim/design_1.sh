...
simulate()
{
  xsim design_1 -key {Behavioral:sim_1:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_afc3.protoinst" -protoinst "protoinst_files/design_1.protoinst" -protoinst "protoinst_files/ram_blk0_inst_0.protoinst" -protoinst "protoinst_files/ram_update0_inst_0.protoinst" -log simulate.log
}
