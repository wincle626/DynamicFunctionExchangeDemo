...
HD_PWD='E:/UDRC_HW/workspaces/vivado2021.2/PR_Test03/PR_Test03.runs/ram_update0_inst_0_axi_bram_ctrl_0_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_update0_inst_0_axi_bram_ctrl_0_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_update0_inst_0_axi_bram_ctrl_0_bram_0.tcl
