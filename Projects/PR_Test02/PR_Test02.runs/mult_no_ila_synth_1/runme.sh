...
HD_PWD='D:/UDRC/workspaces/vivado2019.1/PR_Test02/PR_Test02.runs/mult_no_ila_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log math_rp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source math_rp.tcl
