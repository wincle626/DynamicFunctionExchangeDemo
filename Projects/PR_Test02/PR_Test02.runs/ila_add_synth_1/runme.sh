...
HD_PWD='D:/UDRC/workspaces/vivado2019.1/PR_Test02/PR_Test02.runs/ila_add_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_add.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_add.tcl
